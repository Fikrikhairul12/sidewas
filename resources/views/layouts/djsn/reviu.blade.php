    ...
    <div x-data="{ openModal: false, selectedReview: null }" class="space-y-6">
                        ...
                        @forelse ($reviews as $review)
                            ...
                            <tr class="hover:bg-blue-50/40">
                                ...
                                <td class="px-6 py-6 align-top">
                                    ...
                                    @if ($dokumenAda)
                                        <a href="{{ route('djsn.reviu.dokumen', $review->id) }}"
        ...
        <div x-show="openModal" x-transition.opacity
            ...
            <div @click.outside="openModal = false" x-transition
                ...
                <div class="flex items-start justify-between border-b border-slate-100 px-6 py-5">
                    <div>
                        ...
                        <h2 class="mt-1 text-2xl font-bold text-slate-800">
                            <span x-text="selectedReview?.id_butir_djsn"></span>
                        </h2>
                ...
                <form method="POST" :action="`/djsn/reviu/${selectedReview?.id}`" enctype="multipart/form-data"
                    class="px-6 py-6">
                    @csrf
                    @method('PATCH')
