    ...
    <div class="space-y-6">
        <div class="rounded-2xl border border-blue-100 bg-white p-6 shadow-sm">
            ...
            <p class="mt-2 text-sm text-slate-500">
                Pilih satu atau lebih surat RAGAB untuk dicetak ke PDF.
            </p>
        </div>
                    ...
                    <div class="grid gap-4 md:grid-cols-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="keyword" value="{{ request('keyword') }}"
                                placeholder="Cari ID RAGAB, nomor surat, perihal..."
                                class="w-full rounded-xl border-slate-300 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                    </div>
                                            ...
                                            $butirsForReport = $record->butirRagab
                                                ->map(function ($butir) {
                                                    return [
                                                        ...
                                                        'butir_ragab' => \Illuminate\Support\Str::limit(
                                                            $butir->butir_ragab,
                                                            120,
                                                        ),
                                                    ];
            ...
            <div class="max-h-[90vh] w-full max-w-4xl overflow-y-auto rounded-2xl bg-white shadow-2xl">
                <div class="flex items-start justify-between border-b border-slate-100 px-6 py-5">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-slate-500">
                            Pilih butir RAGAB dan kolom yang ingin ditampilkan di report.
                        </p>
                    </div>
                ...
                <form method="POST" id="customReportForm" target="_blank">
                        ...
                        <div>
                            <div class="flex items-center justify-between gap-3">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-slate-500">
                                        Pilih butir dari surat RAGAB yang sudah dicentang.
                                    </p>
                                </div>
                            ...
                            <div id="customReportButirList"
                                ...
                                <p class="text-sm text-slate-400">
                                    Pilih surat RAGAB terlebih dahulu.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-wrap justify-end gap-3 border-t border-slate-100 px-6 py-4">
                        ...
                        <button type="submit" formaction="{{ route('ragab.report.cetak-custom') }}" formmethod="POST"
                            formtarget="_blank"
                            class="rounded-xl px-5 py-3 text-sm font-bold text-white shadow-sm hover:opacity-90"
                            style="background-color: #2377b9;">
                            Cetak PDF Custom
