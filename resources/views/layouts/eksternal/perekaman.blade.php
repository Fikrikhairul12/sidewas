    ...
    <div x-data="perekamanRagabModal(@js($clusters), @js($direktorats), @js($unitKerjas))" class="space-y-6">
            ...
            <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm text-slate-500">
                        Halaman ini berisi riwayat perekaman Rapat Eksternal.
                    </p>
                </div>
                ...
                <table class="min-w-full divide-y divide-slate-200">
                    ...
                    <tbody class="divide-y divide-slate-200 bg-white">
                        @forelse ($records as $record)
                            @php
                                $butirCount = $record->butirEksternal->count();
                                $detailRecordPayload = [
                                    'id' => $record->id,
                                    'id_eksternal' => $record->id_eksternal,
                                    'nomor_surat' => $record->nomor_surat,
                                    'nama_instansi_pengundang' => $record->nama_instansi_pengundang,
                                    'butirs' => $record->butirEksternal
                                        ->map(function ($butir) {
                                            ...
                                            return [
                                                ...
                                                'tanggal_eksternal' => $butir->tanggal_eksternal
                                ...
                                $editRecordPayload = [
                                    'id' => $record->id,
                                    'update_url' => route('eksternal.perekaman.update', $record->id),
                                    'id_eksternal' => $record->id_eksternal,
                                    'nomor_surat' => $record->nomor_surat,
                                    ...
                                    'butirs' => $record->butirEksternal
                                        ->map(function ($butir) {
                                            ...
                                            return [
                                                ...
                                                'id_butir_eksternal' => $butir->id_butir_eksternal,
                                                'tanggal_eksternal' => $butir->tanggal_eksternal
                                                    ? \Carbon\Carbon::parse($butir->tanggal_eksternal)->format('Y-m-d')
                                                    : '',
                                                'agenda_eksternal' => $butir->agenda_eksternal ?? '',
                                                'keputusan_eksternal' => $butir->keputusan_eksternal ?? '',
                                                'status' => $butir->statusTindakLanjut(),
                                                'cluster_id' => (string) ($butir->cluster_id ?? ''),
                                                'sub_cluster_id' => (string) ($butir->sub_cluster_id ?? ''),
                                                'sub_cluster_ids' => $butir->sub_cluster_id ? [(string) $butir->sub_cluster_id] : [],
                                                'direktorat_ids' => $direktoratButir
                                                    ->pluck('direktorat_id')
                                                    ->filter()
                                                    ->map(fn($id) => (string) $id)
                                                    ->values()
                                                ...
                                                'unit_kerja_ids' => $picUnit
                                                    ...
                                                    ->values()
                                                    ->all(),
                                                'komite_id' => (string) ($komite?->komite_id ?? ''),
                                            ];
                                        })
                                        ->values()
                                        ->all(),
                            ...
                            <tr class="border-b border-slate-200 transition hover:bg-blue-50/40">
                                ...
                                <td class="px-6 py-6 align-top">
                                    <div class="space-y-2">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            @if ($record->dokumen)
                                                <a href="{{ route('eksternal.perekaman.dokumen', $record->id) }}"
                                        ...
                                        <div class="mt-3">
                                            ...
                                            @if ($record->dokumen_memo)
                                                <a href="{{ route('eksternal.perekaman.dokumen-memo', $record->id) }}"
                                                    class="mt-2 inline-flex rounded-lg px-3 py-2 text-xs font-bold text-white hover:opacity-90"
                                                    style="background-color: #6bb17e;">
                                                    Download Memo
                                                </a>
                                ...
                                <td class="px-6 py-6 align-top">
                                    ...
                                    @elseif ($butirCount > 1)
                                        @php
                                            $firstButir = $record->butirEksternal->first();
                                        @endphp

                                        <div class="rounded-xl border border-slate-200 bg-white p-4">
                                            <p class="text-sm font-bold tracking-wide" style="color: #2377b9;">
                                                {{ $firstButir?->id_butir_eksternal }}
                                            </p>
                                ...
                                {{-- Cluster --}}
                                <td class="px-6 py-6 align-top">
                                    @if ($record->butirEksternal->count() > 0)
                                        <div class="space-y-5">
                                            @foreach ($record->butirEksternal as $butir)
                                ...
                                <td class="px-6 py-6 align-top">
                                    ...
                                    <p class="mt-3 text-sm text-slate-500">
                                        {{ $record->butir_eksternal_count ?? $record->butirEksternal->count() }} butir
                                    </p>
                                </td>
                                ...
                                <td class="px-6 py-6 align-top">
                                    <div class="flex flex-wrap justify-center gap-2">
                                        ...
                                        @if (auth()->user()->canRequestDeleteEksternalPerekaman())
                                            <form method="POST"
                                                action="{{ route('eksternal.perekaman.destroy.request', $record->id) }}"
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h2 class="text-2xl font-bold text-slate-800">
                                Detail Butir EKSTERNAL
                            </h2>
                            <p class="mt-1 text-sm font-semibold text-slate-500"
                                x-text="detailRecord?.id_eksternal ?? '-'"></p>
                            <p class="mt-1 text-sm font-medium text-slate-500">
                                Instansi:
                                <span x-text="detailRecord?.nama_instansi_pengundang ?? '-'"></span>
                            </p>
                        </div>
                    </div>
                ...
                <div class="grid max-h-[70vh] overflow-hidden lg:grid-cols-[340px_minmax(0,1fr)]">
                            ...
                            <template x-for="butir in filteredDetailButirs" :key="butir.id">
                                <button type="button" @click="selectDetailButir(butir)"
                                    ...
                                    <span class="block text-sm font-bold" style="color: #2377b9;"
                                        x-text="butir.id_butir_eksternal"></span>
                    ...
                    <div class="max-h-[70vh] overflow-y-auto p-6">
                            ...
                            <div class="space-y-5">
                                <div>
                                    <p class="text-2xl font-bold" style="color: #2377b9;"
                                        x-text="selectedDetailButir.id_butir_eksternal"></p>
                                    <p class="mt-2 text-sm text-slate-500">
                                        Cluster:
                                ...
                                <div class="grid gap-4 md:grid-cols-2">
                                    <div>
                                        <p class="mb-2 text-sm font-bold text-slate-700">Tanggal EKSTERNAL</p>
                                        <div class="rounded-xl border border-slate-200 bg-white px-4 py-4 text-sm font-medium text-slate-700"
                                            x-text="selectedDetailButir.tanggal_eksternal"></div>
                                    </div>

                                    <div>
                                        <p class="mb-2 text-sm font-bold text-slate-700">Agenda EKSTERNAL</p>
                                        <div class="rounded-xl border border-slate-200 bg-white px-4 py-4 text-sm font-medium leading-relaxed text-slate-700"
                                            x-text="selectedDetailButir.agenda_eksternal"></div>
                                    </div>
                                </div>
                        ...
                        <div x-show="!selectedDetailButir"
                            ...
                            Surat ini belum memiliki butir EKSTERNAL.
                        </div>
                    </div>
                </div>
        ...
        <div x-show="openEditModal" x-transition.opacity
            ...
            <div @click.outside="openEditModal = false" x-transition
                ...
                <div class="flex items-start justify-between border-b border-slate-100 px-6 py-5">
                    <div>
                        <p class="text-sm font-semibold uppercase tracking-wide" style="color: #2377b9;">Edit Perekaman Rapat Eksternal</p>
                        <h2 class="mt-1 text-2xl font-bold text-slate-800" x-text="editRecord?.id_eksternal ?? '-'"></h2>
                ...
                <form method="POST" :action="editRecord?.update_url" enctype="multipart/form-data"
                    ...
                    <div class="grid gap-5 lg:grid-cols-2">
                        ...
                        <div class="lg:col-span-2">
                            <label class="mb-2 block text-sm font-semibold text-slate-700">Nama Instansi Pengundang</label>
                            <input type="text" name="nama_instansi_pengundang" x-model="editRecord.nama_instansi_pengundang" required
                                class="w-full rounded-xl border-slate-300 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="butir_id" x-model="selectedEditButirId" @change="syncEditButir()" required
                                ...
                                <template x-for="butir in editRecord?.butirs ?? []" :key="butir.id">
                                    <option :value="butir.id" x-text="butir.id_butir_eksternal"></option>
                                </template>
                            </select>
                        </div>
                        ...
                        <template x-if="selectedEditButir">
                            <div class="contents">
                                <div>
                                    <label class="mb-2 block text-sm font-semibold text-slate-700">Tanggal Eksternal</label>
                                    <input type="date" name="tanggal_eksternal" x-model="selectedEditButir.tanggal_eksternal" required
                                        class="w-full rounded-xl border-slate-300 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                </div>
                                ...
                                <div class="lg:col-span-2">
                                    <label class="mb-2 block text-sm font-semibold text-slate-700">Agenda Eksternal</label>
                                    <input type="text" name="agenda_eksternal" x-model="selectedEditButir.agenda_eksternal" required
                                        class="w-full rounded-xl border-slate-300 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                </div>
                                ...
                                <div class="lg:col-span-2">
                                    ...
                                    <div class="rounded-xl border border-slate-300 bg-white">
                                        ...
                                        <div x-show="selectedUnitKerjaDetail.length > 0" class="border-b border-slate-200 bg-slate-50 p-3">
                                            <p class="mb-2 text-xs font-bold uppercase tracking-wide text-slate-500">PIC Unit Terpilih</p>
                                            <div class="flex flex-wrap gap-2">
                                                <template x-for="unit in selectedUnitKerjaDetail" :key="unit.id">
                                                    <span class="inline-flex items-center gap-2 rounded-full bg-blue-100 px-3 py-1 text-xs font-bold text-blue-700">
                                                        <span x-text="`${unit.kode_unit ?? '-'} - ${unit.nama_unit}`"></span>
                                                        <button type="button" @click="removeUnitKerja(unit.id)" class="text-blue-500 hover:text-red-500">x</button>
                                                    </span>
                                                </template>
                                            </div>
                                        </div>
                                    ...
                                    <p class="mt-2 text-sm font-semibold text-red-600" x-show="unitKerjaValidationMessage"
                                        x-text="unitKerjaValidationMessage"></p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="sub_cluster_id" x-model="selectedEditButir.sub_cluster_id" required
                                        class="w-full rounded-xl border-slate-300 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <div>
                            <label class="mb-2 block text-sm font-semibold text-slate-700">Dokumen Surat Undangan</label>
                        ...
                        <div>
                            <label class="mb-2 block text-sm font-semibold text-slate-700">Dokumen Laporan / Notulensi</label>
        ...
        <div x-show="openCreateModal" x-transition.opacity
            ...
            <div @click.outside="openCreateModal = false" x-transition
                ...
                <div class="flex items-start justify-between border-b border-slate-100 px-6 py-5">
                    <div>
                        ...
                        <h2 class="mt-1 text-2xl font-bold text-slate-800">
                            Tambah Perekaman Rapat Eksternal
                        </h2>

                        <p class="mt-1 text-sm text-slate-500">
                            ID Rapat Eksternal, tanggal jatuh tempo, dan status draft akan dibuat otomatis.
                        </p>
                    </div>
                ...
                <form method="POST" action="{{ route('eksternal.perekaman.store') }}" enctype="multipart/form-data"
                    class="px-6 py-6">
                    @csrf
                    ...
                    <div class="grid gap-5 lg:grid-cols-2">
                        ...
                        <div class="lg:col-span-2">
                            <label class="mb-2 block text-sm font-semibold text-slate-700">
                                Nama Instansi Pengundang
                            </label>
                            <input type="text" name="nama_instansi_pengundang"
                                value="{{ old('nama_instansi_pengundang') }}" required
                                placeholder="Masukkan nama instansi pengundang..."
                                class="w-full rounded-xl border-slate-300 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
        ...
        <div x-show="openButirModal" x-transition.opacity
            ...
            <div @click.outside="openButirModal = false" x-transition
                ...
                <form method="POST" :action="`/eksternal/perekaman/${selectedRecord?.id}/butir`" class="px-6 py-6">
                    @csrf
                    ...
                    <div class="grid gap-5 lg:grid-cols-2">
                        <div>
                            ...
                            <input type="date" name="tanggal_eksternal" required
                                class="w-full rounded-xl border-slate-300 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="agenda_eksternal" required
                                class="w-full rounded-xl border-slate-300 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                placeholder="Masukkan agenda EKSTERNAL...">
                        </div>
