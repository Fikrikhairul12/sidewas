    ...
    <div x-data="{
        ...
        <div class="rounded-2xl border border-blue-100 bg-white p-6 shadow-sm">
            ...
            <p class="mt-2 text-sm text-slate-500">
                Reviu dilakukan per butir Keputusan RAWAS setelah seluruh PIC Unit menginput tindak lanjut.
            </p>
        </div>
        ...
        @include('layouts.rawas.partials.filter-lanjutan', [
            ...
            'keywordPlaceholder' =>
                'Cari ID Keputusan RAWAS, ID butir, nomor surat, agenda, keputusan, PIC unit, tindak lanjut, atau hasil reviu...',
        ])
        ...
        <div class="overflow-hidden rounded-2xl border border-blue-100 bg-white shadow-sm">
            <div class="border-b border-blue-50 px-6 py-5">
                <h2 class="text-lg font-bold text-slate-800">
                    Daftar Reviu Butir Keputusan RAWAS
                </h2>
                                ...
                                $detailTindakLanjutPayload = [
                                    ...
                                    'tindak_lanjuts' => $tindakLanjutItems
                                        ->map(function ($tl) use ($butir) {
                                            $unitKerja = $tl->butirPic?->unitKerja;
                                            $unitLabel =
                                                ($unitKerja?->kode_unit ?? '-') .
                                                ' - ' .
                                                ($unitKerja?->nama_unit ?? '-');
                                ...
                                <td class="px-6 py-6 align-top">
                                    ...
                                    @if ($review->dokumen)
                                        <div class="mt-4">
                                            ...
                                            <a href="{{ route('rawas.reviu.dokumen', $review->id) }}"
                            ...
                            <tr>
                                <td colspan="4" class="px-6 py-12 text-center">
                                    <p class="text-sm font-semibold text-slate-600">
                                        Belum ada butir Keputusan RAWAS yang memiliki tindak lanjut.
                                    </p>
                                </td>
                            </tr>
                        @endforelse
                ...
                <div class="flex items-start justify-between border-b border-slate-100 px-6 py-5">
                    <div>
                        <h2 class="text-2xl font-bold text-slate-800">
                            Detail Tindak Lanjut RAWAS
                        </h2>
                        <p class="mt-1 text-sm font-semibold text-slate-500" x-text="detailButir?.id_rawas ?? '-'"></p>
                    </div>
        ...
        <div x-show="openModal" x-transition.opacity
            ...
            <div @click.outside="openModal = false" x-transition
                ...
                <div class="flex items-start justify-between border-b border-slate-100 px-6 py-5">
                    <div>
                        <p class="text-sm font-semibold uppercase tracking-wide" style="color: #2377b9;">
                            Form Reviu Tindak Lanjut Butir Keputusan RAWAS
                        </p>

                        <h2 class="mt-1 text-2xl font-bold text-slate-800">
                            <span x-text="selectedReview?.id_butir_rawas"></span>
                        </h2>
                ...
                <form method="POST" :action="`/rawas/reviu/${selectedReview?.id}`" enctype="multipart/form-data"
                    class="px-6 py-6">
                    @csrf
                    @method('PATCH')
